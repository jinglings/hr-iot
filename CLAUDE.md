...
This project is indexed by GitNexus as **hr-iot** (64223 symbols, 127477 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/hr-iot/context` | Codebase overview, check index freshness |
| `gitnexus://repo/hr-iot/clusters` | All functional areas |
| `gitnexus://repo/hr-iot/processes` | All execution flows |
| `gitnexus://repo/hr-iot/process/{name}` | Step-by-step execution trace |
...
| Work in the Ui area (1136 symbols) | `.claude/skills/generated/ui/SKILL.md` |
| Work in the Notify area (226 symbols) | `.claude/skills/generated/notify/SKILL.md` |
| Work in the Permission area (209 symbols) | `.claude/skills/generated/permission/SKILL.md` |
| Work in the Device area (169 symbols) | `.claude/skills/generated/device/SKILL.md` |
| Work in the Scada area (164 symbols) | `.claude/skills/generated/scada/SKILL.md` |
| Work in the Router area (158 symbols) | `.claude/skills/generated/router/SKILL.md` |
| Work in the Oauth2 area (154 symbols) | `.claude/skills/generated/oauth2/SKILL.md` |
| Work in the Sms area (131 symbols) | `.claude/skills/generated/sms/SKILL.md` |
| Work in the Erp area (121 symbols) | `.claude/skills/generated/erp/SKILL.md` |
| Work in the Impl area (120 symbols) | `.claude/skills/generated/impl/SKILL.md` |
| Work in the Trigger area (102 symbols) | `.claude/skills/generated/trigger/SKILL.md` |
| Work in the Util area (102 symbols) | `.claude/skills/generated/util/SKILL.md` |
| Work in the User area (99 symbols) | `.claude/skills/generated/user/SKILL.md` |
| Work in the Config area (90 symbols) | `.claude/skills/generated/config/SKILL.md` |
| Work in the File area (90 symbols) | `.claude/skills/generated/file/SKILL.md` |
| Work in the Dict area (88 symbols) | `.claude/skills/generated/dict/SKILL.md` |
| Work in the Tenant area (88 symbols) | `.claude/skills/generated/tenant/SKILL.md` |
| Work in the Scheduler area (85 symbols) | `.claude/skills/generated/scheduler/SKILL.md` |
| Work in the Dept area (84 symbols) | `.claude/skills/generated/dept/SKILL.md` |
| Work in the Social area (84 symbols) | `.claude/skills/generated/social/SKILL.md` |
