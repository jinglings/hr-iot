...
public interface ErrorCodeConstants {
        ...
        // ========== 物模型模板 1-050-007-000 ==========
        ErrorCode THING_MODEL_TEMPLATE_NOT_EXISTS = new ErrorCode(1_050_007_000, "物模型模板不存在");
        ErrorCode THING_MODEL_TEMPLATE_CODE_EXISTS = new ErrorCode(1_050_007_001, "模板编码已存在");
        ErrorCode THING_MODEL_TEMPLATE_SYSTEM_CANNOT_DELETE = new ErrorCode(1_050_007_002, "系统模板不允许删除");
        ErrorCode THING_MODEL_TEMPLATE_SYSTEM_CANNOT_UPDATE = new ErrorCode(1_050_007_003, "系统模板不允许修改");
        ErrorCode THING_MODEL_TEMPLATE_TSL_INVALID = new ErrorCode(1_050_007_004, "TSL格式无效");
        ErrorCode THING_MODEL_TEMPLATE_CATEGORY_NOT_EXISTS = new ErrorCode(1_050_007_005, "模板分类不存在");
        ...
        // ========== 设备标签 1-050-006-000 ==========
        ErrorCode DEVICE_TAG_NOT_EXISTS = new ErrorCode(1_050_006_000, "设备标签不存在");
        ErrorCode DEVICE_TAG_KEY_VALUE_EXISTS = new ErrorCode(1_050_006_001, "标签键值已存在");
        ErrorCode DEVICE_TAG_BIND_LIMIT_EXCEEDED = new ErrorCode(1_050_006_002, "设备绑定标签数量超过限制（最多20个）");
        ErrorCode DEVICE_TAG_ALREADY_BOUND = new ErrorCode(1_050_006_003, "设备已绑定该标签");
        ErrorCode DEVICE_TAG_NOT_BOUND = new ErrorCode(1_050_006_004, "设备未绑定该标签");
        ErrorCode DEVICE_TAG_PRESET_CANNOT_DELETE = new ErrorCode(1_050_006_005, "预置标签不允许删除");
        ...
        ErrorCode OTA_TASK_RECORD_UPDATE_PROGRESS_FAIL_NO_EXISTS = new ErrorCode(1_050_008_202,
                        "更新 OTA 升级记录进度失败，原因：该设备没有进行中的升级记录");
